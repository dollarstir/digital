        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.reviewers*',3)}}">
                        <i class="menu-icon fas fa-briefcase-medical"></i>
                        <span class="menu-title">@lang('Manage Reviewers')</span>
                        @if($banned_reviewers_count > 0 || $email_unverified_reviewers_count > 0 || $sms_unverified_reviewers_count > 0)
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.reviewers*',2)}}">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.reviewers.new')}}">
                                <a href="{{route('admin.reviewers.new')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Add New Reviewer')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.reviewers.all')}}">
                                <a href="{{route('admin.reviewers.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.reviewers.active')}} ">
                                <a href="{{route('admin.reviewers.active')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Active Reviewers')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.reviewers.banned')}} ">
                                <a href="{{route('admin.reviewers.banned')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Banned Reviewers')</span>
                                    @if($banned_reviewers_count)
                                        <span class="menu-badge pill bg--primary ml-auto">{{$banned_reviewers_count}}</span>
                                    @endif
                                </a>
                            </li>

                            <li class="sidebar-menu-item  {{menuActive('admin.reviewers.emailUnverified')}}">
                                <a href="{{route('admin.reviewers.emailUnverified')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Email Unverified')</span>

                                    @if($email_unverified_reviewers_count)
                                        <span
                                            class="menu-badge pill bg--primary ml-auto">{{$email_unverified_reviewers_count}}</span>
                                    @endif
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.reviewers.smsUnverified')}}">
                                <a href="{{route('admin.reviewers.smsUnverified')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('SMS Unverified')</span>
                                    @if($sms_unverified_reviewers_count)
                                        <span
                                            class="menu-badge pill bg--primary ml-auto">{{$sms_unverified_reviewers_count}}</span>
                                    @endif
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.reviewers.login.history')}}">
                                <a href="{{route('admin.reviewers.login.history')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Login History')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{menuActive('admin.reviewers.email.all')}}">
                                <a href="{{route('admin.reviewers.email.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.product*',3)}}">
                        ...
                        @if($pending_product_count > 0 || $soft_product_count > 0 || $hard_product_count > 0 || $update_pending_product_count > 0)
                            <span class="menu-badge pill bg--primary ml-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                        @endif
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.product*',2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.product.softrejected')}}">
                                <a href="{{route('admin.product.softrejected')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.product.hardrejected')}}">
                                <a href="{{route('admin.product.hardrejected')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.product.resubmit*')}}">
                                <a href="{{route('admin.product.resubmit')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.product.update.pending')}}">
                                <a href="{{route('admin.product.update.pending')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.comment*')}}">
                    <a href="{{route('admin.comment')}}" class="nav-link ">
                        ...
                        <span class="menu-title">@lang('Manage Comments')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.sell.log*')}}">
                    <a href="{{route('admin.sell.log')}}" class="nav-link ">
                        <i class="menu-icon lab la-sellsy"></i>
                        <span class="menu-title">@lang('Sells Log')</span>
                    </a>
                </li>
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.users*',2)}}">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.users.featured.all')}}">
                                <a href="{{route('admin.users.featured.all')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
