            ...
            <div class="row mb-none-30">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--17 b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">{{$approvedProducts}}</span>
                            </div>
                            <div class="desciption">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('admin.users.update',[$user->id])}}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group  col-md-4  col-sm-3 col-12">
                                <label class="form-control-label font-weight-bold">@lang('Make Top Author') </label>
                                <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger"
                                       data-toggle="toggle" data-on="@lang('Yes')" data-off="@lang('No')" name="top_author"
                                       @if($user->top_author) checked @endif>
                            </div>
                        </div>
