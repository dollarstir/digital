            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        ...
                        <div class="card card-deposit border--base">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text addon-bg h-100"><i class="fa fa-font"></i></span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text addon-bg h-100"><i class="fa fa-credit-card"></i></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
