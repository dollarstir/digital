                    ...
                    <div class="col-xxl-7 col-lg-6 pe-xxl-5">
                        <div class="withdraw-preview-sidebar">
                            ...
                            <ul class="caption-list mt-4">
                                <li>
                                    <div class="caption">@lang('Total Price')</div>
                                    <div class="value">{{getAmount($data->amount)}} {{__($general->cur_text)}}</div>
                                </li>
                                <li class="text--danger">
                                    <div class="caption">@lang('Payment Charge')</div>
                            ...
                            <div class="text-end mt-4">
                                @if( 1000 >$data->method_code)
                                    <a href="{{route('user.deposit.confirm')}}" type="submit" class="btn btn--base w-100">@lang('Confirm')</a>
                                @else
                                    <a href="{{route('user.payment.manual.confirm')}}" type="submit" class="btn btn--base w-100">@lang('Confirm')</a>
                                @endif
                            </div>
                        </div>
                    </div>
