        ...
        <div class="account-area-left">
            <div class="account-area-left-inner">
                <div class="text-center mb-5">
                    ...
                    <p class="fs-14px text-white mt-4">@lang('Please Verify Your Email to Get Access')</p>
                    <p class="fs-14px text-white mt-4">@lang('Your E-mail') : <b>{{auth()->user()->email}}</b></p>
                </div>
            ...
            @csrf
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="email_verified_code[]" autocomplete="off" placeholder="@lang('Enter the code')" class="form--control">
                    </div>
                </div>
                <button type="submit" class="btn btn--base w-100 mt-3">@lang('Submit')</button>
                <div class="mt-3 d-flex flex-wrap justify-content-between">
                    <p class="fs-14px text-white">@lang('Please check including your Junk/Spam Folder. if not found, you can') <a href="{{route('user.send_verify_code')}}?type=email" class="text--base"> @lang('Resend code')</a></p>
