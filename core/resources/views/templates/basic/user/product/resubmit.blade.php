                    ...
                    <div class="col-lg-12">
                        <div class="tab-content-area">
                            <div class="user-profile-area">
                                <form action="{{route('user.product.resubmit.store',Crypt::encrypt($product->id))}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5 form-group">
                                            ...
                                            <div class="input-group mb-2 mr-sm-2">
                                                <input type="number" class="form--control regular-price" name="regular_price" placeholder="@lang('Enter Amount')" value="{{getAmount($product->regular_price)- $product->category->buyer_fee}}"  required>
                                        ...
                                        <div class="col-lg-5 form-group">
                                            ...
                                            <div class="input-group mb-2 mr-sm-2">
                                                <input type="number" class="form--control extended-price" name="extended_price" placeholder="@lang('Enter Amount')" value="{{getAmount($product->extended_price)- $product->category->buyer_fee}}"  required>
                                                <div class="input-group-append">
                                                  <div class="input-group-text h-100">{{$general->cur_text}}</div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row addedField">
                                            ...
                                            <div class="col-lg-3 form-group">
                                                <label>@lang('Upload Screenshot')</label>
                                                <div id="uploader" class="it">
                                                    <div class="row uploadDoc">
                                                        <div class="col-xxl-12 col-xl-12">
                                                            <div class="fileUpload btn btn-orange">
                                        ...
                                        <div class="col-lg-12 form-group">
                                            <button type="submit" class="btn btn--base w-100">@lang('Resubmit Now')</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
