                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="category_id" id="category" class="form--control" required>
                                                            @foreach ($categories as $item)
                                                                ...
                                                                <option data-subcategory="{{$item->subcategories}}" data-category_details="{{$item->categoryDetails}}" data-buyerfee="{{$item->buyer_fee}}" value="{{$item->id}}">{{$item->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="row uploadDoc">
                                                        <div class="col-xxl-12 col-xl-12">
                                                            <div class="fileUpload btn btn-orange">
                                                                ...
                                                                <input type="file" class="upload up from--control validate" name="file" accept=".zip" required onchange="fileURL(this);" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        (function ($) {
            ...
            $('#category').on('change',function(){
                ...
                if ($('.regular-price').val() == '') {
                    ...
                    if (parseFloat($('.regular-price').val()) >= parseFloat(minPrice)){
                        $('.final-regular-price').val( parseFloat($('.regular-price').val()) + parseFloat(buyerFee));
                    }
                }
                ...
                if ($('.extended-price').val() == '') {
                    ...
                    if (parseFloat($('.extended-price').val()) >= parseFloat(minPrice)){
                        $('.final-extended-price').val( parseFloat($('.extended-price').val()) + parseFloat(buyerFee));
                    }
                }
