            ...
            <div class="col-lg-8">
              ...
              <div class="product-details-content mt-50">
                <ul class="nav nav-tabs custom--nav-tabs style--two">
                  ...
                  <li class="nav-item">
                    <a href="{{ route('product.reviews',[str_slug(__($product->name)),$product->id]) }}" class="nav-link active">@lang('Review')</a>
                  </li>
                  <li class="nav-item">
                      ...
                      @forelse ($ratings as $item)
                        <div class="single-review">
                            <div class="single-review__top">
                                <div class="left">
                                    <h6 class="author-name"><a href="{{route('username.search',strtolower($item->user->username))}}">{{$item->user->username}}</a></h6>
