...
<div class="page-wrapper default-version">
    <div class="form-area bg_img" data-background="{{asset('assets/reviewer/images/1.jpg')}}">
        <div class="form-wrapper">
            ...
            <form action="{{route('reviewer.verify_sms')}}" method="POST" class="cmn-form mt-30">
                @csrf
                ...
                <div class="form-group d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{route('reviewer.send_verify_code')}}?type=phone" class="text-muted text--small">@lang('Try to send
                        again')</a>
                </div>
...
@endsection
@push('script-lib')
    <script src="{{asset('assets/reviewer/js/jquery.inputLettering.js')}}"></script>
@endpush
@push('style')
    <style>
