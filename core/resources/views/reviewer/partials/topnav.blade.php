    ...
    <div class="navbar__right">
        <ul class="navbar__action-list">
          ...
          <span class="navbar-user">
            <span class="navbar-user__thumb"><img src="{{ getImage(imagePath()['profile']['reviewer']['path'].'/'. auth()->guard('reviewer')->user()->image,imagePath()['profile']['reviewer']['size']) }}"
                    alt="@lang('image')"></span>
