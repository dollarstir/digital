...
<body>
	<header class="section-bg py-2 text-center">
		<div class="container">
			...
			<h4><?php echo str_rot13('<n uers="uggcf://AhyyWhatyr.pbz">Ahyyrq Ol AhyyWhatyr.pbz</n>');?> </h4>
		</div>
	</header>
...
";
   ...
   $stmt->execute();						
	...
	<footer class="section-bg py-3 text-center">
		<div class="container">
			<p class="m-0 font-weight-bold">&copy;<?php echo Date('Y') ?> - All Right Reserved by <a href="https://viserlab.com/">ViserLab</a> | <?php echo str_rot13('<n uers="uggcf://AhyyWhatyr.pbz">Ahyyrq Ol AhyyWhatyr.pbz</n>');?> </p>
		</div>
	</footer>
	<style>
		#hide{
